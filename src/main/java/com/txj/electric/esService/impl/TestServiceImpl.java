package com.txj.electric.esService.impl;

import com.alibaba.fastjson.JSONObject;
import com.txj.electric.esDao.TestDao;
...
public class TestServiceImpl implements TestService {
    ...
    public List<TestBean> findByNameOrDesc(String text) {
        ...
        return testDao.findAllByNameOrDesc(text, text);
    }
    ...
    public List<TestBean> improveSearch(String text) {
        ...
        // 搜索方式
        // 首先构造多关键字查询条件
        MultiMatchQueryBuilder matchQueryBuilder = QueryBuilders.multiMatchQuery(text, "name","desc").field("name", 10);
        // 添加条件到布尔查询
...
//        searchSourceBuilder.fetchSource(new String[]{"name","studymodel","price","timestamp"},new String[]{});
    ...
    private List<TestBean> obtainTestBeans(SearchResponse searchResponse) {
        ...
        for (SearchHit hit : searchHits) {
            ...
            TestBean testBean = JSONObject.parseObject(content,TestBean.class); //生成pojo对象
